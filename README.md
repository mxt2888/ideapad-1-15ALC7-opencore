...
# Due to github's 100 files per upload limit you have to add manually the Resources folder from [OpenCorePKG](https://github.com/acidanthera/OpenCorePkg/releases/download/1.0.6/OpenCore-1.0.6-RELEASE.zip)
